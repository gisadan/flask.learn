...
def index():
    ...
    listgraph = []
    f = open('text2.csv', 'r')
    stock_lists = csv.reader(f)
    for lists in stock_lists:
        for i in lists:
        ...
        #### html로 저장된 반응형 graph html 파일 그대로 불러오기 ####
        ...
        ### 여기서부터 뉴스 ###
            # url = "https://finance.naver.com/item/news_news.nhn?code={}&page=&sm=entity_id.basic&clusterId==".format(i)
    ...
    return render_template('index.html', listnews = listnews, lists = listgraph )
